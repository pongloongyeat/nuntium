...
final class AppColors {
  ...
  static const purpleDark = Color(0xff2536a7);
  ...
  static const blackDark = Color(0xff22242f);
  static const blackPrimary = Color(0xff333647);
  static const blackLight = Color(0xff44485f);
  static const blackLighter = Color(0xff555a77);
  static const greyDark = Color(0xff666c8e);
